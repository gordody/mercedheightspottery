   ...
   <main>                                                                                                                                                     
     ...
     <div class="layout">                                                                                                                                     
       ...
       <div class="details">                                                                                                                                  
         ...
         <dl class="specs">                                                                                                                                   
           {#if piece.dimensions}                                                                                                                             
             <dt>Dimensions</dt><dd>{piece.dimensions}</dd>                                                                                                   
           {/if}                                                                                                                                              
           {#if piece.clay}                                                                                                                                   
             <dt>Clay</dt><dd>{piece.clay}</dd>                                                                                                               
           {/if}                                                                                                                                              
           {#if piece.glaze}                                                                                                                                  
             <dt>Glaze</dt><dd>{piece.glaze}</dd>                                                                                                             
           {/if}                                                                                                                                              
           {#if piece.fired}                                                                                                                                  
             <dt>Firing</dt><dd>{piece.fired}</dd>                                                                                                            
           {/if}                                                                                                                                              
         </dl>                                                                                                                                                
   ...
   <style>                                                                                                                                                    
     ...
     .main-image img { width: 100%; border-radius: 4px; }                                                                                                     
     ...
     .thumbnails button.active { border-color: #222; }                                                                                                        
     .thumbnails img { width: 100%; height: 100%; object-fit: cover; }                                                                                        
                                                                                                                                                              
     h1 { font-size: 1.8rem; margin-bottom: 0.5rem; }                                                                                                         
                                                                                                                                                              
     .price { font-size: 1.4rem; margin: 0.25rem 0; }                                                                                                         
     ...
     .description { color: #444; line-height: 1.6; margin: 1rem 0; }                                                                                          
                                                                                                                                                              
     dl.specs { margin: 1.5rem 0; display: grid; grid-template-columns: auto 1fr; gap: 0.4rem 1rem; }                                                         
     dt { font-weight: 600; color: #555; font-size: 0.9rem; }                                                                                                 
     dd { margin: 0; }                                                                                                                                        
     ...
     .buy-button:hover { background: #444; }                                                                                                                  
   </style>